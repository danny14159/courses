...
<div class="col-md-8">
			...
			<span class="prompt_text">学科管理</span>
			<div class="toolbg">所有学科
							
			<button class="btn btn-default btn-xs" onclick="on_add(this);">添加学科</button>
			</div>	
...
<div class="col-md-4">
	<div class="content">
		<div class="contentTitle"><span class="prompt_text">语文</span>&nbsp;&nbsp;学科详情</div>
		<div>
			<table class="table">
				<tr><td style="text-align:right">学科名称：</td><td>语文</td></tr>
...
var on_add=function(dom){
	window.utils.alert('请输入新学科信息','ERROR');
	insertRecord(
		$('#tbmain'),
		{
			'1':{
